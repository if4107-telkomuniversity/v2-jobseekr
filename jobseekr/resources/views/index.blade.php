            ...
            <div class="columns">
              <div class="column">
                <div class="box-button"><br/>
                  <a href="?key=j/auth" class="button is-info is-large is-fullwidth">Start looking for jobs</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="column is-5">
          <div class="box has-text-centered home-choose-user-box">
            ...
            <div class="columns">
              <div class="column">
                <div class="box-button"><br/>
                  <a href="?key=r/auth" class="button is-success is-large is-fullwidth">Start hiring</a>
                </div>
              </div>
            </div>
          </div>
