        ...
        <div class="columns">
          ...
          <div class="column is-8 jobs-content">
            <div class="box has-text-centered single-container">
              ...
              <span class="subtitle is-5 company-name">{company.name}</span>
              <span class="subtitle is-5">. Give them some time to</span><br/>
              <span class="subtitle is-5">review your application. You will be notified soon!</span><br/>
              <br/>
              <a href="?key=j/dashboard" class="button is-info">&nbsp&nbspGot it!&nbsp&nbsp</a>
            </div>
          </div>
          <div class="column">
          </div>
